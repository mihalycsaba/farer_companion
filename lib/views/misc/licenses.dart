...
import 'package:farer_companion/common/card_theme.dart';
import 'package:farer_companion/common/functions/url_launcher.dart';
import 'package:farer_companion/views/misc/oss_licenses.dart';
                          ...
                          children: [
                            ...
                            Flexible(
                              child: GestureDetector(
                                onTap: () =>
                                    urlLauncher(allDependencies[index].repository!),
                                child: Text(
                      ...
                      ? Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: GestureDetector(
                                onTap: () =>
                                    urlLauncher(allDependencies[index].homepage!),
                                child: Text(
